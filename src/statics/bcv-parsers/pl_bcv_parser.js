...
// `translation` is a translation object, but all we care about is the string.
  ...
  bcv_parser.prototype.regexps.translations = /(?:(?:NP))\b/gi;
  ...
  bcv_parser.prototype.languages = ["pl"];

  bcv_parser.prototype.regexps.space = "[\\s\\xa0]";

  bcv_parser.prototype.regexps.escaped_passage = /(?:^|[^\x1f\x1e\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014]|tytuł(?![a-z])|rozdział[óo]w|werset[óo]w|rozdziały|rozdział|n(?![n])|wersety|werset|rozdz|oraz|wers|por|rr|nn|do|r|i|w|[a-e](?!\w)|$)+)/gi; // Beginning of string or not in the middle of a word or immediately following another book. Only count a book if it's part of a sequence: `Matt5John3` is OK, but not `1Matt5John3`
  ...
  bcv_parser.prototype.regexps.match_end_split = /\d\W*tytuł|\d\W*n(?![n])(?:[\s\xa0*]*\.)?|\d\W*nn(?:[\s\xa0*]*\.)?|\d[\s\xa0*]*[a-e](?!\w)|\x1e(?:[\s\xa0*]*[)\]\uff09])?|[\d\x1f]/gi; //ff09 is a full-width closing parenthesis
  ...
  bcv_parser.prototype.regexps.first = `(?:Pierwsza|Pierwsze|Pierwszy|1|I)\\.?${bcv_parser.prototype.regexps.space}*`;

  bcv_parser.prototype.regexps.second = `(?:Druga|Drugi|2|II)\\.?${bcv_parser.prototype.regexps.space}*`;

  bcv_parser.prototype.regexps.third = `(?:Trzecia|Trzeci|3|III)\\.?${bcv_parser.prototype.regexps.space}*`;

  bcv_parser.prototype.regexps.range_and = "(?:[&\u2013\u2014-]|(?:oraz|por|i)|do)";

  bcv_parser.prototype.regexps.range_only = "(?:[\u2013\u2014-]|do)";
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1[\s\xa0]*Mj)|(?:Pierwsz[aey][\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Mo(?:y[zż]eszowe|j[zż]eszowa)|\.[\s\xa0]*Mo(?:y[zż]eszowe|j[zż]eszowa)|[\s\xa0]*Mo(?:y[zż]eszowe|j[zż]eszowa))|Moj(?:[zż]eszowa|[zż]))|[1I]\.[\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Mo(?:y[zż]eszowe|j[zż]eszowa)|\.[\s\xa0]*Mo(?:y[zż]eszowe|j[zż]eszowa)|[\s\xa0]*Mo(?:y[zż]eszowe|j[zż]eszowa))|Moj(?:[zż]eszowa|[zż]))|[1I][\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Mo(?:y[zż]eszowe|j[zż]eszowa)|\.[\s\xa0]*Mo(?:y[zż]eszowe|j[zż]eszowa)|[\s\xa0]*Mo(?:y[zż]eszowe|j[zż]eszowa))|Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Rodzaju|(?:I[\s\xa0]*Moj[zż]|1[\s\xa0]*Moj[zż])eszowa|Genezis|I[\s\xa0]*Moj[zż]|1[\s\xa0]*Moj[zż]|I[\s\xa0]*Moj|1[\s\xa0]*M(?:oj)?|Ro?dz|Gen)|(?:Rodzaju))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Exod"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Drug[ai][\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])eszowa|Moj(?:[zż]eszowa|[zż]))|(?:II|2)\.[\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])eszowa|Moj(?:[zż]eszowa|[zż]))|(?:II|2)[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])eszowa|Ks(?:i[eę]g[ai][\s\xa0]*Wyj[sś]|\.[\s\xa0]*Wyj[sś]|[\s\xa0]*Wyj[sś])cia|(?:II[\s\xa0]*Moj[zż]|2[\s\xa0]*Moj[zż])eszowa|II[\s\xa0]*Moj[zż]|II[\s\xa0]*Moj|2[\s\xa0]*Moj[zż]|Exodus|2[\s\xa0]*Moj|Ex(?:od)?|2[\s\xa0]*Mj|2[\s\xa0]*M|Wy?j|Wy)|(?:Wyj[sś]cia))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Bel"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Opowiadaniem[\\s\\xa0]*o[\\s\\xa0]*Belu[\\s\\xa0]*i[\\s\\xa0]*w[eę][zż]u|Bel(?:a[\\s\\xa0]*i[\\s\\xa0]*w[eę][zż]a)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Trzeci(?:a[\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])eszowa|Moj(?:[zż]eszowa|[zż]))|[\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])eszowa|Moj(?:[zż]eszowa|[zż])))|(?:III|3)\.[\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])eszowa|Moj(?:[zż]eszowa|[zż]))|(?:III|3)[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])eszowa|K(?:s(?:i[eę]g[ai][\s\xa0]*Kapła[nń]|\.[\s\xa0]*Kapła[nń]|[\s\xa0]*Kapła[nń])|aplan)ska|(?:III[\s\xa0]*Moj[zż]|3[\s\xa0]*Moj[zż])eszowa|III[\s\xa0]*Moj[zż]|III[\s\xa0]*Moj|3[\s\xa0]*Moj[zż]|3[\s\xa0]*Moj|Kapl|K(?:apł|p[lł])|3[\s\xa0]*Mj|3[\s\xa0]*M|Lev)|(?:Kapła[nń]ska))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:4[\s\xa0]*Mj)|(?:Czwarta[\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])eszowa|Moj(?:[zż]eszowa|[zż]))|(?:IV|4)\.[\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])eszowa|Moj(?:[zż]eszowa|[zż]))|(?:IV|4)[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])eszowa|(?:IV[\s\xa0]*Moj[zż]|4[\s\xa0]*Moj[zż])eszowa|Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Liczb|IV[\s\xa0]*Moj[zż]|IV[\s\xa0]*Moj|4[\s\xa0]*Moj[zż]|4[\s\xa0]*M(?:oj)?|Num|Lb)|(?:Liczb))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:M[aą]dro[sś][cć][\\s\\xa0]*Syracha|Ekl(?:ezjastyka|i)|Eklezjastyk|Syracha|Syr|Sir))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:M(?:[aą]dr(?:o[sś][cć][\\s\\xa0]*Salomona)?|dr)|Ks(?:i[eę]g[ai][\\s\\xa0]*M[aą]dro[sś]|\\.[\\s\\xa0]*M[aą]dro[sś]|[\\s\\xa0]*M[aą]dro[sś])ci|Wis))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Lam"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:L(?:a(?:m(?:entacje(?:[\\s\\xa0]*Jeremiasza)?)?)?|m)|Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Lamentacji|Treny(?:[\\s\\xa0]*Jeremiasza)?|Tr))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*Jeremiasza|EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Modlitwa[\\s\\xa0]*Manassesa|PrMan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:5[\s\xa0]*Mj)|(?:Ks(?:i[eę]g[ai][\s\xa0]*Powt(?:[o\xF3]rzonego)?|\.[\s\xa0]*Powt(?:[o\xF3]rzonego)?|[\s\xa0]*Powt(?:[o\xF3]rzonego)?)[\s\xa0]*Prawa|(?:Pi[aą]ta[\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])e|Moj[zż]e)|[5V]\.[\s\xa0]*(?:Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])e|Moj[zż]e)|(?:[5V][\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Moj[zż]|\.[\s\xa0]*Moj[zż]|[\s\xa0]*Moj[zż])|V[\s\xa0]*Moj[zż]|5[\s\xa0]*Moj[zż])e)szowa|Pi[aą]ta[\s\xa0]*Moj[zż]|[5V]\.[\s\xa0]*Moj[zż]|V[\s\xa0]*Moj[zż]|5[\s\xa0]*Moj[zż]|V[\s\xa0]*Moj|5[\s\xa0]*M(?:oj)?|(?:Deu|Pw)t)|(?:Powt[o\xF3]rzonego[\s\xa0]*Prawa))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Josh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Jozuego|Jo(?:zuego|sh|z)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Judg"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai][\\s\\xa0]*S[eę]dzi[o\\xF3]|\\.[\\s\\xa0]*S[eę]dzi[o\\xF3]|[\\s\\xa0]*S[eę]dzi[o\\xF3])w|S[eę]?dz|Judg)|(?:S[eę]dzi[o\\xF3]w))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ruth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai][\\s\\xa0]*Rut(?:hy)?|\\.[\\s\\xa0]*Rut(?:hy)?|[\\s\\xa0]*Rut(?:hy)?)|R(?:uth|ut?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pierwsz[aey][\s\xa0]*(?:Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*)?Ezdrasza|[1I]\.[\s\xa0]*(?:Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*)?Ezdrasza|[1I][\s\xa0]*(?:Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*)?Ezdrasza|1Esd))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Drug[ai][\s\xa0]*(?:Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*)?Ezdrasza|(?:II|2)\.[\s\xa0]*(?:Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*)?Ezdrasza|(?:II|2)[\s\xa0]*(?:Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*)?Ezdrasza|2Esd))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Isa"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Izajasza|I(?:zajasza|za?|sa)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Drug[ai][\s\xa0]*(?:Samuel(?:a[\s\xa0]*(?:Drug[ai][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|(?:II|2)\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|(?:II|2)[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)[\s\xa0]*Samuel|ow)|Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Samuelow)a|(?:II|2)\.[\s\xa0]*(?:Samuel(?:a[\s\xa0]*(?:Drug[ai][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|(?:II|2)\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|(?:II|2)[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)[\s\xa0]*Samuel|ow)|Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Samuelow)a|II[\s\xa0]*(?:Samuel(?:a[\s\xa0]*(?:Drug[ai][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|(?:II|2)\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|(?:II|2)[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)[\s\xa0]*Samuel|ow)|Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Samuelow)a|2(?:[\s\xa0]*Samuel(?:a[\s\xa0]*(?:Drug[ai][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|(?:II|2)\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|(?:II|2)[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)[\s\xa0]*Samuel|ow)a|[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Samuelowa|[\s\xa0]*Sam?|(?:Sa|[\s\xa0]*S)m))|(?:2[\s\xa0]*Samuela))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pierwsz[aey][\s\xa0]*(?:Samuel(?:a[\s\xa0]*[\s\xa0]*(?:Pierwsz[aey][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|[1I]\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|[1I][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)[\s\xa0]*Samuel|ow)|Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Samuelow)a|[1I]\.[\s\xa0]*(?:Samuel(?:a[\s\xa0]*[\s\xa0]*(?:Pierwsz[aey][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|[1I]\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|[1I][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)[\s\xa0]*Samuel|ow)|Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Samuelow)a|1(?:[\s\xa0]*Samuel(?:a[\s\xa0]*[\s\xa0]*(?:Pierwsz[aey][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|[1I]\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|[1I][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)[\s\xa0]*Samuel|ow)a|[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Samuelowa|[\s\xa0]*Sam?|(?:Sa|[\s\xa0]*S)m)|I[\s\xa0]*(?:Samuel(?:a[\s\xa0]*[\s\xa0]*(?:Pierwsz[aey][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|[1I]\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|[1I][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)[\s\xa0]*Samuel|ow)|Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Samuelow)a)|(?:1[\s\xa0]*Samuela))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Czwarta[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]|\.[\s\xa0]*Kr[o\xF3]|[\s\xa0]*Kr[o\xF3])lewska|(?:Drug[ai][\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]|\.[\s\xa0]*Kr[o\xF3]|[\s\xa0]*Kr[o\xF3])|(?:II|2)\.[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]|\.[\s\xa0]*Kr[o\xF3]|[\s\xa0]*Kr[o\xF3])|II[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]|\.[\s\xa0]*Kr[o\xF3]|[\s\xa0]*Kr[o\xF3])|2[\s\xa0]*K(?:s(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]|\.[\s\xa0]*Kr[o\xF3]|[\s\xa0]*Kr[o\xF3])|r[o\xF3]))lewska|(?:IV|4)\.[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]|\.[\s\xa0]*Kr[o\xF3]|[\s\xa0]*Kr[o\xF3])lewska|Drug[ai][\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]l[o\xF3]|\.[\s\xa0]*Kr[o\xF3]l[o\xF3]|[\s\xa0]*Kr[o\xF3]l[o\xF3])w|(?:IV|4)[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]|\.[\s\xa0]*Kr[o\xF3]|[\s\xa0]*Kr[o\xF3])lewska|(?:II|2)\.[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]l[o\xF3]|\.[\s\xa0]*Kr[o\xF3]l[o\xF3]|[\s\xa0]*Kr[o\xF3]l[o\xF3])w|II[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]l[o\xF3]|\.[\s\xa0]*Kr[o\xF3]l[o\xF3]|[\s\xa0]*Kr[o\xF3]l[o\xF3])w|2(?:[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]l[o\xF3]|\.[\s\xa0]*Kr[o\xF3]l[o\xF3]|[\s\xa0]*Kr[o\xF3]l[o\xF3])w|[\s\xa0]*Krl|Kgs)|(?:Drug[ai]|(?:II|2)\.|II)[\s\xa0]*Kr[o\xF3]lewska|2[\s\xa0]*Kr[o\xF3]l))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pierwsz[aey][\s\xa0]*K(?:s(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w)|\.[\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w)|[\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w))|r[o\xF3]lewska)|(?:(?:Trzeci(?:a[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)|(?:III|3)\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|(?:III|3)[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)[\s\xa0]*Kr[o\xF3]|1[\s\xa0]*Kr[o\xF3])lewska|[1I]\.[\s\xa0]*K(?:s(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w)|\.[\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w)|[\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w))|r[o\xF3]lewska)|1[\s\xa0]*Ks(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w)|\.[\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w)|[\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w))|I[\s\xa0]*K(?:s(?:i[eę]g[ai][\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w)|\.[\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w)|[\s\xa0]*Kr[o\xF3]l(?:ewska|[o\xF3]w))|r[o\xF3]lewska)|1(?:[\s\xa0]*Kr[o\xF3]l|[\s\xa0]*Krl|Kgs)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Drug[ai][\s\xa0]*K(?:s(?:i[eę]g[ai]|\.)?[\s\xa0]*K)?ronik|(?:II|2)\.[\s\xa0]*K(?:s(?:i[eę]g[ai]|\.)?[\s\xa0]*K)?ronik|II[\s\xa0]*K(?:s(?:i[eę]g[ai]|\.)?[\s\xa0]*K)?ronik|2(?:[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Kronik|[\s\xa0]*Kronik|[\s\xa0]*Kron|[\s\xa0]*Krn|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pierwsz[aey][\s\xa0]*K(?:s(?:i[eę]g[ai]|\.)?[\s\xa0]*K)?ronik|[1I]\.[\s\xa0]*K(?:s(?:i[eę]g[ai]|\.)?[\s\xa0]*K)?ronik|1(?:[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Kronik|[\s\xa0]*Kronik|[\s\xa0]*Kron|[\s\xa0]*Krn|Chr)|I[\s\xa0]*K(?:s(?:i[eę]g[ai]|\.)?[\s\xa0]*K)?ronik))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Ezra"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Ezdrasza|Ez(?:drasza|dr?|ra|r)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Neh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Nehemiasza|Ne(?:hemiasza|h)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["GkEsth"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:GkEsth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Esth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Estery|Est(?:ery|h)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Job"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai][\\s\\xa0]*(?:Ij|Hi|J)|\\.[\\s\\xa0]*(?:Ij|Hi|J)|[\\s\\xa0]*(?:Ij|Hi|J))oba|(?:Hi|J)ob|Hi)|(?:(?:Hi|J)oba))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai][\\s\\xa0]*Psalm[o\\xF3]|\\.[\\s\\xa0]*Psalm[o\\xF3]|[\\s\\xa0]*Psalm[o\\xF3])w|Ps(?:almy|alm)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Modlitw[aą][\\s\\xa0]*Azariasza|P(?:ie[sś][nń][\\s\\xa0]*Azariasza|rAzar)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai][\\s\\xa0]*Przy(?:powie[sś]ci[\\s\\xa0]*Salomona|sł[o\\xF3]w)|\\.[\\s\\xa0]*Przy(?:powie[sś]ci[\\s\\xa0]*Salomona|sł[o\\xF3]w)|[\\s\\xa0]*Przy(?:powie[sś]ci[\\s\\xa0]*Salomona|sł[o\\xF3]w))|Pr(?:zyp|zy?|ov)?)|(?:Przy(?:powie[sś]ci|sł[o\\xF3]w)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
      ...
      },
      {
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Pie[sś](?:n(?:i[aą][\\s\\xa0]*trzech[\\s\\xa0]*młodzie[nń]c[o\\xF3]|[\\s\\xa0]*trzech[\\s\\xa0]*młodzie[nń]c[o\\xF3])|ń[\\s\\xa0]*trzech[\\s\\xa0]*młodzie[nń]c[o\\xF3])w|SgThree))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Song"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:P(?:ie[sś][nń][\\s\\xa0]*(?:nad[\\s\\xa0]*Pie[sś]niami|Salomona)|np|NP)|Song))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jer"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Jeremiasza|J(?:eremiasza|e?r)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Ezechiela|Ez(?:echiela|ek|e)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Daniela|D(?:aniela|an?|n)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Ozeasza|Ozeasza|Hos|Oz))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Joel"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Proroctwo[\\s\\xa0]*Ioelowe|Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Joela|J(?:oela|l)|Joel))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Amos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Amosa|Am(?:osa|os)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Obad"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Proroctwo[\\s\\xa0]*Abdyaszowe|Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Abdiasza|Abdiasza|Obad|Ab))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jonah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Proroctwo[\\s\\xa0]*Ionaszowe|Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Jonasza|Jona(?:sza|h)|Jon))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mic"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Micheasza|Mi(?:cheasza|ch?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Nah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Proroctwo[\\s\\xa0]*Nahumowe|Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Nahuma|Na(?:huma|ch)|Nah?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hab"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Proroctwo[\\s\\xa0]*Abakukowe|(?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Ha|Ha|A)bakuka|Hab?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zeph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Proroctwo[\\s\\xa0]*Sofoniaszowe|Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Sofoniasza|Sofoniasza|Zeph|Sof?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hag"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Proroctwo[\\s\\xa0]*Aggieuszowe|Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Aggeusza|Aggeusza|Hag|Ag))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zech"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Zachariasza|Z(?:achariasza|a(?:ch)?|ech)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Proroctwo[\\s\\xa0]*Malachyaszowe|Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Malachiasza|M(?:alachiasza|l)|Mal))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ew(?:angelia[\\s\\xa0]*(?:w(?:edług[\\s\\xa0]*[sś]w\\.?|g[\\s\\xa0]*[sś]w\\.?)[\\s\\xa0]*)?Mateusza|\\.[\\s\\xa0]*Mateusza|[\\s\\xa0]*Mat(?:eusza)?)|M(?:at(?:eusza|t)|at(?:eusz)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mark"],
      ...
      {
        osis: ["Luke"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ew(?:angelia[\\s\\xa0]*(?:w(?:edług[\\s\\xa0]*[sś]w\\.?|g[\\s\\xa0]*[sś]w\\.?)[\\s\\xa0]*)?Łukasza|\\.[\\s\\xa0]*Łukasza|[\\s\\xa0]*Łuk(?:asza)?)|Ł(?:ukasza|k)|Łuk(?:asz)?|L(?:uke|k)|Luk))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Acts"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Dz(?:iej(?:ach[\\s\\xa0]*Apostolskich|e(?:[\\s\\xa0]*Apostolskie|[\\s\\xa0]*Apost)?)|[\\s\\xa0]*Ap)?|Acts))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ap(?:o(?:kalipsa[\\s\\xa0]*(?:[SŚ]wi[eę]tego|[sś]w\\.|[sś]w)[\\s\\xa0]*Jana)?)?|Objawienie[\\s\\xa0]*[sś]w\\.[\\s\\xa0]*Jana|Objawienie[\\s\\xa0]*[sś]w[\\s\\xa0]*Jana|Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Apokalipsy|Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Objawienia|Objawienie[\\s\\xa0]*Jana|Obj|Rev)|(?:Objawienie|Apokalipsa))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1John)|(?:Pierwsz[aey][\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?)?Jana|[1I]\.[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?)?Jana|1[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Jana|J(?:ana|an|n)?)|I[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?)?Jana))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2John)|(?:Drug[ai][\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?)?Jana|(?:II|2)\.[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?)?Jana|II[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?)?Jana|2[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Jana|J(?:ana|an|n)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:3John)|(?:Trzeci(?:a[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?)?|[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?)?)Jana|(?:III|3)\.[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?)?Jana|III[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?)?Jana|3[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Jana|J(?:ana|an|n)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["John"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ew(?:angelia[\\s\\xa0]*(?:w(?:edług[\\s\\xa0]*[sś]w\\.?|g[\\s\\xa0]*[sś]w\\.?)[\\s\\xa0]*)?Jana|\\.[\\s\\xa0]*Jana|[\\s\\xa0]*Jana?)|J(?:(?:oh)?n|ana|an)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*(?:[sś]w\\.?[\\s\\xa0]*Pawła[\\s\\xa0]*)?do[\\s\\xa0]*Rzymian|R(?:zymian|z(?:ym)?|om)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Drug[ai][\s\xa0]*(?:List[\s\xa0]*[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*do[\s\xa0]*Koryntian|list[\s\xa0]*do[\s\xa0]*Koryntian|Korynt(?:ian|[o\xF3]w))|(?:II|2)\.[\s\xa0]*(?:List[\s\xa0]*[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*do[\s\xa0]*Koryntian|list[\s\xa0]*do[\s\xa0]*Koryntian|Korynt(?:ian|[o\xF3]w))|II[\s\xa0]*(?:List[\s\xa0]*[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*do[\s\xa0]*Koryntian|list[\s\xa0]*do[\s\xa0]*Koryntian|Korynt(?:ian|[o\xF3]w))|2(?:[\s\xa0]*List[\s\xa0]*[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*do[\s\xa0]*Koryntian|[\s\xa0]*list[\s\xa0]*do[\s\xa0]*Koryntian|[\s\xa0]*Koryntian|[\s\xa0]*Korynt[o\xF3]w|[\s\xa0]*Kor|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pierwsz[aey][\s\xa0]*(?:List[\s\xa0]*[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*do[\s\xa0]*Koryntian|list[\s\xa0]*do[\s\xa0]*Koryntian|Korynt(?:ian|[o\xF3]w))|[1I]\.[\s\xa0]*(?:List[\s\xa0]*[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*do[\s\xa0]*Koryntian|list[\s\xa0]*do[\s\xa0]*Koryntian|Korynt(?:ian|[o\xF3]w))|1(?:[\s\xa0]*List[\s\xa0]*[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*do[\s\xa0]*Koryntian|[\s\xa0]*list[\s\xa0]*do[\s\xa0]*Koryntian|[\s\xa0]*Koryntian|[\s\xa0]*Korynt[o\xF3]w|[\s\xa0]*Kor|Cor)|I[\s\xa0]*(?:List[\s\xa0]*[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*do[\s\xa0]*Koryntian|list[\s\xa0]*do[\s\xa0]*Koryntian|Korynt(?:ian|[o\xF3]w))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*(?:[sś]w\\.?[\\s\\xa0]*Pawła[\\s\\xa0]*do[\\s\\xa0]*Galacjan|do[\\s\\xa0]*Gala(?:cjan|t[o\\xF3]w))|Ga(?:lacjan|lat[o\\xF3]w|l)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*(?:[SŚ]wi[eę]tego[\\s\\xa0]*Pawła[\\s\\xa0]*Apostoła[\\s\\xa0]*do[\\s\\xa0]*Efez[o\\xF3]w|(?:[sś]w\\.?[\\s\\xa0]*Pawła[\\s\\xa0]*)?do[\\s\\xa0]*Efezjan)|E(?:fezjan|fez[o\\xF3]w|f(?:ez)?|ph)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*(?:[sś]w\\.?[\\s\\xa0]*Pawła[\\s\\xa0]*)?do[\\s\\xa0]*Filipian|F(?:ilipens[o\\xF3]w|lp)|Filipian|F(?:il(?:ip)?|l)|Phil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*(?:[sś]w\\.?[\\s\\xa0]*Pawła[\\s\\xa0]*)?do[\\s\\xa0]*Kolosan|Kolosens[o\\xF3]w|Kolosan|Kol|Col))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Drug[ai][\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tesaloniczan|Tesalonic(?:ens[o\xF3]w|zan))|(?:II|2)\.[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tesaloniczan|Tesalonic(?:ens[o\xF3]w|zan))|II[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tesaloniczan|Tesalonic(?:ens[o\xF3]w|zan))|2(?:[\s\xa0]*List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tesaloniczan|[\s\xa0]*Tesalonicens[o\xF3]w|[\s\xa0]*Tesaloniczan|Thess|[\s\xa0]*Tes)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pierwsz[aey][\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tesaloniczan|Tesalonic(?:ens[o\xF3]w|zan))|[1I]\.[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tesaloniczan|Tesalonic(?:ens[o\xF3]w|zan))|1(?:[\s\xa0]*List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tesaloniczan|[\s\xa0]*Tesalonicens[o\xF3]w|[\s\xa0]*Tesaloniczan|Thess|[\s\xa0]*Tes)|I[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tesaloniczan|Tesalonic(?:ens[o\xF3]w|zan))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Drug[ai][\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*)?Tymoteusza|(?:II|2)\.[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*)?Tymoteusza|II[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*)?Tymoteusza|2(?:[\s\xa0]*List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tymoteusza|[\s\xa0]*Tymoteusza|(?:[\s\xa0]*Ty|Ti|[\s\xa0]*T)m)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pierwsz[aey][\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tymoteusza|Tym(?:oteusza)?)|[1I]\.[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tymoteusza|Tym(?:oteusza)?)|1(?:[\s\xa0]*List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tymoteusza|[\s\xa0]*Tymoteusza|(?:[\s\xa0]*Ty|Ti|[\s\xa0]*T)m)|I[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*Pawła[\s\xa0]*)?do[\s\xa0]*Tymoteusza|Tym(?:oteusza)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*(?:[sś]w\\.?[\\s\\xa0]*Pawła[\\s\\xa0]*)?do[\\s\\xa0]*Tytusa|T(?:ytusa|itus|yt|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phlm"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*(?:[sś]w\\.?[\\s\\xa0]*Pawła[\\s\\xa0]*)?do[\\s\\xa0]*Filemona|Filemona|(?:File|(?:Ph|F)l)m))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*do[\\s\\xa0]*(?:Hebrajczyk[o\\xF3]|[ZŻ]yd[o\\xF3])w|Hebrajczyk[o\\xF3]w|[ZŻ]yd[o\\xF3]w|Hebr?|[ZŻ]yd|Hbr))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*(?:powszechny[\\s\\xa0]*[SŚ]wi[eę]tego[\\s\\xa0]*Iakuba[\\s\\xa0]*Apostoł|(?:[sś]w\\.?[\\s\\xa0]*)?Jakub)a|J(?:akuba|ak|as|k)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:Pe|[\s\xa0]*P)t)|(?:Drug[ai][\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Piotra|Piotra?)|(?:II|2)\.[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Piotra|Piotra?)|II[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Piotra|Piotra?)|2[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Piotra|P(?:iotra|iotr|io)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:Pe|[\s\xa0]*P)t)|(?:Pierwsz[aey][\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Piotra|Piotra?)|[1I]\.[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Piotra|Piotra?)|1[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Piotra|P(?:iotra|iotr|io)?)|I[\s\xa0]*(?:List[\s\xa0]*(?:[sś]w\.?[\s\xa0]*)?Piotra|Piotra?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jude"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:List[\\s\\xa0]*(?:powszechny[\\s\\xa0]*[SŚ]wi[eę]tego[\\s\\xa0]*Iudasa[\\s\\xa0]*Apostoła|(?:[sś]w\\.?[\\s\\xa0]*)?Judy)|J(?:ud[ey]|ud|d)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai][\\s\\xa0]*Tobi(?:asz|t)|\\.[\\s\\xa0]*Tobi(?:asz|t)|[\\s\\xa0]*Tobi(?:asz|t))a|To?b))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jdt"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Judyty|J(?:udyty|dt)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bar"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ks(?:i[eę]g[ai]|\\.)?[\\s\\xa0]*Barucha|Ba(?:rucha|r)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sus"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Opowiadaniem[\\s\\xa0]*o[\\s\\xa0]*Zuzannie|Zuzanna|Sus))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Drug[ai][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|(?:II|2)\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|II[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|2(?:[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|[\s\xa0]*Ma?ch|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Trzeci(?:a[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?|[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?)[\s\xa0]*Machabejska|(?:III|3)\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|III[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|3(?:[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|[\s\xa0]*Ma?ch|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Czwarta[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|(?:IV|4)\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|IV[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|4(?:[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|[\s\xa0]*Ma?ch|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pierwsz[aey][\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|[1I]\.[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|1(?:[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska|[\s\xa0]*Ma?ch|Macc)|I[\s\xa0]*Ks(?:i[eę]g[ai]|\.)?[\s\xa0]*Machabejska))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c40 = "nn",
        peg$c41 = peg$literalExpectation("nn", false),
        peg$c42 = /^[a-z]/,
        ...
        peg$c47 = /^[n]/,
        peg$c48 = peg$classExpectation(["n"], false, false),
        peg$c49 = function(val_1) { return {"type": "next_v", "value": [val_1], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c50 = function(val_1, val_2) { return {"type": "integer_title", "value": [val_1, val_2], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c51 = "/9\x1F",
        peg$c52 = peg$literalExpectation("/9\x1F", false),
        peg$c53 = function(val) { return {"type": "context", "value": val.value, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c54 = "/2\x1F",
        peg$c55 = peg$literalExpectation("/2\x1F", false),
        peg$c56 = ".1",
        peg$c57 = peg$literalExpectation(".1", false),
        peg$c58 = /^[0-9]/,
        peg$c59 = peg$classExpectation([["0", "9"]], false, false),
        peg$c60 = function(val) { return {"type": "bc", "value": [val, {"type": "c", "value": [{"type": "integer", "value": 151, "indices": [peg$currPos - 2, peg$currPos - 1]}], "indices": [peg$currPos - 2, peg$currPos - 1]}], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c61 = function(val_1, val_2) { return {"type": "bcv", "value": [val_1, {"type": "v", "value": [val_2], "indices": [val_2.indices[0], val_2.indices[1]]}], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c62 = /^[a-e]/,
        peg$c63 = peg$classExpectation([["a", "e"]], false, false),
        peg$c64 = function(val) { return {"type": "v", "value": [val], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c65 = "r",
        peg$c66 = peg$literalExpectation("r", false),
        peg$c67 = "ozdzia\u0142y",
        peg$c68 = peg$literalExpectation("ozdzia\u0142y", true),
        peg$c69 = "ozdzia\u0142",
        peg$c70 = peg$literalExpectation("ozdzia\u0142", true),
        peg$c71 = /^[\xF3o]/i,
        peg$c72 = peg$classExpectation(["\xF3", "o"], false, true),
        peg$c73 = "w",
        peg$c74 = peg$literalExpectation("w", false),
        peg$c75 = "ozdz",
        peg$c76 = peg$literalExpectation("ozdz", false),
        peg$c77 = function() { return {"type": "c_explicit"} },
        peg$c78 = "erset",
        peg$c79 = peg$literalExpectation("erset", false),
        peg$c80 = "ersety",
        peg$c81 = peg$literalExpectation("ersety", false),
        peg$c82 = "ers",
        peg$c83 = peg$literalExpectation("ers", false),
        peg$c84 = function() { return {"type": "v_explicit"} },
        peg$c85 = ":",
        ...
        peg$c91 = "oraz",
        peg$c92 = peg$literalExpectation("oraz", false),
        peg$c93 = "por",
        peg$c94 = peg$literalExpectation("por", false),
        peg$c95 = "i",
        peg$c96 = peg$literalExpectation("i", false),
        peg$c97 = function() { return "" },
        peg$c98 = /^[\-\u2013\u2014]/,
        peg$c99 = peg$classExpectation(["-", "\u2013", "\u2014"], false, false),
        peg$c100 = "do",
        peg$c101 = peg$literalExpectation("do", false),
        peg$c102 = "tytu\u0142",
        peg$c103 = peg$literalExpectation("tytu\u0142", true),
        peg$c104 = function(val) { return {type:"title", value: [val], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c105 = "from",
        peg$c106 = peg$literalExpectation("from", false),
        peg$c107 = "of",
        ...
        peg$c113 = "book",
        peg$c114 = peg$literalExpectation("book", false),
        peg$c115 = /^[([]/,
        peg$c116 = peg$classExpectation(["(", "["], false, false),
        peg$c117 = /^[)\]]/,
        peg$c118 = peg$classExpectation([")", "]"], false, false),
        peg$c119 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c120 = "\x1E",
        peg$c121 = peg$literalExpectation("\x1E", false),
        peg$c122 = function(val) { return {"type": "translation", "value": val.value, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c123 = ",000",
        peg$c124 = peg$literalExpectation(",000", false),
        peg$c125 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c126 = /^[^\x1F\x1E([]/,
        peg$c127 = peg$classExpectation(["\x1F", "\x1E", "(", "["], true, false),
        peg$c128 = function(val) { return {"type": "word", "value": val.join(""), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c129 = function(val) { return {"type": "stop", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c130 = /^[\s\xa0*]/,
